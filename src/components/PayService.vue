  ...
  <div class="payService">
    <v-container>
      ...
      <div class="input">
        ...
        <v-text-field variant="outlined" label="Código" placeholder="Código" v-model="invoiceCode" clearable />
      </div>
      <div class="input">
        <p class="text">Ingresá el monto de la factura:</p>
        <v-text-field variant="outlined" label="Monto" v-model="amount" type="number" min="1"
          placeholder="Ingresa el monto" prefix="$" />
      </div>
      <div class="input">
        <p class="text">Selecciona el método de pago:</p>
        <v-select variant="outlined" :items="['Cuenta', 'Tarjeta de crédito']" v-model="paymentMethod"
          label="Método de Pago" placeholder="Selecciona un método" clearable />
      </div>
      ...
      <div v-if="paymentMethod === 'Tarjeta de crédito'" class="selectCard">
        ...
        <v-select variant="outlined" :items="cards" v-model="selectedCard" label="Tarjeta de Crédito"
          placeholder="Selecciona una tarjeta" clearable />
      </div>
